...
handle_que(void *ptr)
{
    ...
    cout << "Hello, my name is " << pthread_self() << endl;
...
string 
Server::put_command(Message message)
{
    if(debug)
...
string 
Server::list_command(Message message)
{
    if(debug)
...
string 
Server::get_command(Message message)
{
    if(debug)
...
string 
Server::reset_command(Message message)
{
    if(debug)
